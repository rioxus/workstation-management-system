          ...
          <div className="space-y-3">
            {recentRequests
              .filter((request) => {
                ...
                // Managers can see pending, approved, rejected, partially_allocated, and partially_approved requests
                if (userRole === 'manager') {
                  return request.status === 'approved' || request.status === 'rejected' || request.status === 'pending' || request.status === 'partially_allocated' || request.status === 'partially_approved';
                }
