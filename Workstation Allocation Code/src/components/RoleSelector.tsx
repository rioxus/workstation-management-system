...
import { MapPin, Shield, Users, Wrench, Monitor } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl mb-4 text-white">Workstation Allotment Tracker</h1>
          <div className="flex items-center justify-center gap-2 text-white text-2xl mb-4">
            <Monitor className="w-8 h-8" />
            <span>Smart Workspace Management</span>
          </div>
          <p className="text-slate-300 text-lg">Select your role to access the system</p>
          <p className="text-slate-400 text-sm mt-2">600+ WFO Employees • 5 Locations</p>
        </div>
